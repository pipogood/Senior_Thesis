...
function initialize(box)
	...
	num_class = box:get_setting(12)
	third_class = _G[box:get_setting(13)]
	forth_class = _G[box:get_setting(14)]
	...
	for i = 1, number_of_trials do
		...
		table.insert(sequence, 1, forth_class)
	end

	-- randomize the sequence
	for i = 1, number_of_trials do
		a = math.random(1, number_of_trials*num_class)
		b = math.random(1, number_of_trials*num_class)
		swap = sequence[a]
...
function process(box)
	...
	for i = 1, number_of_trials*num_class do
